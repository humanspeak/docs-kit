...
export { default as CodeReferenceV2 } from './components/CodeReferenceV2.svelte'
...
export { default as DemoSplitV2 } from './components/DemoSplitV2.svelte'
...
export { default as EmbeddedExampleV2 } from './components/EmbeddedExampleV2.svelte'
